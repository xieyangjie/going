...
type Validator struct {
	...
	customerValidator 	map[string]map[string]*validatorTag
}
...
func NewValidator() *Validator {
	...
	validator.customerValidator = make(map[string]map[string]*validatorTag)
	return &validator
}
...
func (this *Validator) AddValidator(fieldName string, validatorName string, value string, code string, message string) {
	...
	var vtm = this.customerValidator[fieldName]
	if vtm == nil {
		vtm = make(map[string]*validatorTag)
	}
	vtm[validatorName] = vt
	this.customerValidator[fieldName] = vtm
}
